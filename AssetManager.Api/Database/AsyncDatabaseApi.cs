...
namespace AssetManager.Api.Database
{
    public class AsyncDatabaseApi : IAsyncDatabaseApi
    {
        ...
        public Task<IAssetType> GetAssetType( Guid databaseId, int assetTypeId )
        {
            return Task.Factory.StartNew( () => this.databaseApi.GetAssetType( databaseId, assetTypeId ) );
        }
        ...
        public Task<Asset> AsyncGetAsset( Guid databaseId, int assetTypeId )
        {
            return Task.Factory.StartNew( () => this.databaseApi.GetAsset( databaseId, assetTypeId ) );
        }
